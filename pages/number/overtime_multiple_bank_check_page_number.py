...
from import_data import import_numerik, import_fitur_numerik, import_dictionary_numerik
...
# File path for data
# numerik_file_path = "data/summarized_numerik.xlsx"
# df_numerik = pd.read_excel(numerik_file_path)
...
list_columns_to_check = import_fitur_numerik()
...
item_dict_list = [dict_numerik[item] for item in list_columns_to_check]
# Map back from display value -> original key
reverse_map = {dict_numerik[item]: item for item in list_columns_to_check}
...
# Default values
default_feature = "total_ckpn_stage_2_dan_3" if "total_ckpn_stage_2_dan_3" in list_columns_to_check else list_columns_to_check[0]
default_display = dict_numerik[default_feature]
